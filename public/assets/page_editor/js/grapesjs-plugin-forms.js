  ...
  () =>
    (() => {
      ...
      const m = function (e, t) {
        ...
        var m = u(
          {
            ...
            category: { id: "forms", label: "فرم ها" },
            block: function () {
              return {};
            },
          },
        ...
        !(function (e) {
          var t = e.Components,
            d = { name: "name", label: "نام" },
            u = { name: "placeholder", label: "متن پیش فرض" },
            m = { type: "checkbox", name: "required" , label: "اجباری"},
            h = function (e, t) {
                ...
                traits: [
                  {
                    ...
                    label: "متد",
                    options: [
                      { value: "get", name: "دریافت", label: "دریافت" },//GET
                      { value: "post", name: "ارسال", label: "ارسال" },//POST
                    ],
                  },
                  { name: "action", label: "رویداد" },
                ],
              },
            },
            view: {
                  ...
                  traits: [
                    ...
                    u,
                    {
                      ...
                      options: [
                        ...
                        { value: "password", name: "پسورد" },
                        { value: "number", name: "اعداد" },
                      ],
                    },
                    m,
                  ],
            ...
            t.addType(i, {
              ...
              model: {
                defaults: {
                  ...
                  droppable: !1,
                  highlightable: !1,
                  components: [h("گزینه ی اول", "گزینه ی 1"), h("گزینه ی دوم", "گزینه ی 2")],
                  traits: [d, { name: "options", label: "گزینه ها", type: "select-options" }, m],
                },
              },
              ...
              model: {
                defaults: {
                  ...
                  traits: [
                    ...
                    m,
                    { type: "checkbox", name: "checked" , label: "تیک خورده"},
                  ],
                },
              },
              view: {
            ...
            t.addType(p, {
              ...
              model: {
                defaults: {
                  ...
                  text: "تایید",
                  traits: [
                    { name: "text", changeProp: !0, label: "متن" },
                    {
                      type: "select",
                      name: "type",
                      label: "نوع",
                      options: [
                        { value: "button", name: "دکمه" },
                        { value: "submit", name: "تایید" },
                        { value: "reset", name: "تنظیم مجدد" },
                      ],
                    },
                  ],
                },
            ...
            t.addType(c, {
              ...
              model: {
                defaults: {
                  tagName: "label",
                  components: "Label",
                  traits: [{ name: "for", label:"برچسب برای" }],
                },
              },
            });
        })(e),
          ...
          (function (e, t) {
            ...
            m(n, {
              ...
              content: {
                ...
                components: [
                  {
                    components: [{ type: c, components: "اسم" }, { type: o }],
                  },
                  {
                    components: [
                      { type: c, components: "ایمیل" },
                      { type: o, attributes: { type: "email" } },
                    ],
                  },
                  {
                    components: [
                      { type: c, components: "جنسیت" },
                      { type: s, attributes: { value: "M" } },
                      { type: c, components: "مرد" },
                      { type: s, attributes: { value: "F" } },
                      { type: c, components: "زن" },
                    ],
                  },
                  {
                    components: [
                      { type: c, components: "پیام" },
                      { type: a },
                    ],
                  },
                  { components: [ { type: c, components: "تایید" },{ type: p }] },
                ],
              },
            }),
              m(o, {
