                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item"
                                       href="{{ url('/registrationsSearch?keyword=' . $page->title ) }}">
                                        ثبت نامی ها
                                    </a>
...
@section('scripts')
    <script>
        ...
        document.getElementById('custom_checkbox').addEventListener('change', function () {
            var customInputContainer = document.getElementById('sms_text_container');
