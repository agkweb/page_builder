...
<ol class="breadcrumb" style="direction: ltr;justify-content: right;">
    <li class="breadcrumb-item active">ویرایش آزمون: {{ $quiz->title }}</li>
            ...
            <div class="card" style="text-align: start;">
                <form action="{{ route('quizzes.update', ['quiz' => $quiz]) }}" method="post">
                    ...
                    <div class="card-header">
                        <strong>ویرایش آزمون: {{ $quiz->title }}</strong>
                    </div>
                    <div class="card-block d-flex row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex row ">
                                ...
                                <input type="text" class="form-control col-8" id="title" name="title" value="{{ $quiz->title }}">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group d-flex row ">
                                <label for="duration" class="col-3">مدت آزمون:</label>
                                <input type="number" class="form-control col-8" id="duration" name="duration" value="{{ $quiz->duration }}">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select id="is_active" name="is_active" class="form-control input-lg">
                                        <option {{ $quiz->is_active == 1 ? 'selected' : '' }} value="1">فعال</option>
                                        <option {{ $quiz->is_active == 0 ? 'selected' : '' }} value="0">غیرفعال</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12 my-1 row d-flex justify-content-start" id="questions">
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <a class="dropdown-item" href="{{ route('quizzes.edit_question', ['question' => $question]) }}">ویرایش</a>
                                            <a href="{{ route('quizzes.delete_question', ['question' => $question]) }}" class="dropdown-item" >حذف</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('quizzes.index') }}" class="btn btn-sm btn-danger"><i class="fa fa-ban"></i> بازگشت</a>
                    </div>
                </form>
            </div>
        </div>
