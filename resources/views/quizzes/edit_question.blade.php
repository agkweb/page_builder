    ...
    <div class="row d-flex col-12">
        <div class="col-sm-12">
            <div class="card" style="text-align: start;">
                <form action="{{ route('quizzes.update_question', ['question' => $question]) }}" method="post">
                        ...
                        @foreach($question->answers as $answer)
                            <div class="col-12">
                                <div class="form-group d-flex row col-12 justify-content-center">
                                    ...
                                    <a href="{{ route('quizzes.delete_answer', ['answer' => $answer]) }}" class="btn btn-danger col-1 mx-1">حذف</a>
                                </div>
                            </div>
                        @endforeach
