...
<div class="wrapper container">
    <div class="d-flex row justify-content-center">
        <div class="col-9 mb-2 mr-4" style="text-align: justify;">
            <a href="{{ route('quizzes.index') }}" class="btn btn-primary mr-0">
                آزمون ها
            </a>
        </div>
        <form class="col-9 justify-content-center" method="POST" action="{{ route('quizzes.exportInExcel', ['quiz' => $quiz]) }}">
            @csrf
            <div class="col-12">
                <div class="card text-end d-flex">
                    <div class="card-header" style="text-align: right;">
                        <strong>خروجی آزمون: {{ $quiz->title }}</strong>
                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('quizzes.index') }}" class="btn btn-sm btn-danger"><i class="fa fa-ban"></i> برگشت</a>
                    </div>
                </div>
            </div>
        </form>
